...
function Roadmap() {
  const months = [
    ...
    ['DEC 2026', 'Mobile & Year in Review', 'Mobile app beta for App Store and Google Play, a builder API for reading and embedding city data, and a slower, deeper read of your year in public — what stayed lit, what changed shape, annual city health reports, and a mint calendar for the next year.', false],
  ];
