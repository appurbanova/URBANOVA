  ...
  return <div className="noise"><SiteHeader /><main>
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 pb-16 pt-14 sm:px-8 md:grid-cols-[.9fr_1.1fr] md:gap-8 md:pb-24 md:pt-24">
        ...
        <div className="relative min-h-[330px] animate-rise [animation-delay:120ms] md:min-h-[540px]"><div className="absolute -inset-12 bg-[radial-gradient(circle,rgba(244,185,78,.13),transparent_55%)]" /><CityMap active={['signal', 'workshop', 'commons']} /><div className="absolute -bottom-3 right-2 z-10 border border-primary/40 bg-[#12172a]/90 px-4 py-3 backdrop-blur-md"><div className="font-mono text-[9px] uppercase tracking-[.15em] text-primary">City health</div><div className="mt-1 flex items-end gap-2"><span className="font-display text-3xl font-semibold">86.4</span><span className="mb-1 font-mono text-[10px] text-muted-foreground">/ 100</span></div></div></div>
      </div>
    </section>
